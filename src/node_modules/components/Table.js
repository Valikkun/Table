...
import {getTable, getTableLength} from 'selectors'
...
class Table extends Component {
	...
	renderButtons() {
		const {tableLength, activePage, loadPage, fetchBigTable, fetchTable} = this.props
		const pages = []
		for (let i = 1; i<=Math.ceil(tableLength/50); i++) {
			pages.push(i)
		}
		return (
			<div>
